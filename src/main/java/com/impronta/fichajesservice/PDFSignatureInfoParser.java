...
public class PDFSignatureInfoParser {
	...
	public static void main(String[] args) throws IOException, CertificateException, NoSuchAlgorithmException,
			InvalidKeyException, NoSuchProviderException, SignatureException, InvalidNameException {
	...
	public static List<PDFSignatureInfo> getPDFSignatureInfo(InputStream is)
	...
	public static List<PDFSignatureInfo> getPDFSignatureInfo(byte[] byteArray)
			throws IOException, CertificateException, NoSuchAlgorithmException, InvalidKeyException,
			NoSuchProviderException, SignatureException, InvalidNameException {
